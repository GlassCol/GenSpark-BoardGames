...
public class MainMenuController {
    ...
    protected void onStartGameButton() throws IOException {
        ...
        if(Settings.isPlayingChess()) {
            fxmlLoader = new FXMLLoader(Main.class.getResource("chess-view.fxml"));
        } else {
            fxmlLoader = new FXMLLoader(Main.class.getResource("checkers-view.fxml"));
        }
